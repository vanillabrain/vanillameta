    ...
    await dataSource
      ...
      .values([
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#6aa7eb","aggregation":"sum","type":"line"},{"color":"#47a8ea","aggregation":"sum","type":"bar"}],"label":true}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":{"color":[],"aggregation":"sum","label":"{b}","radius":["20%","75%"]}}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":{"color":[],"aggregation":"sum","label":"{b}","radius":["30%","75%"]}}',
        ...
        },
        {
          ...
          category: 'SCORE',
          option:
            '{"header":{"title":"타이틀을 입력하세요","fontSize":20,"color":"#4A4A4A"},"content":{"aggregation":"sum","fontSize":50,"color":"#4A4A4A"}}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":{"color":["#2870c4","#4ecef6","#ffd43b","#fa5a5a"],"aggregation":"sum"},"label":true}',
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#FA5A5A","aggregation":"sum"},{"color":"#2870C4","aggregation":"sum"},{"color":"#E03B3B","aggregation":"sum"},{"color":"#215DA3","aggregation":"sum"}]}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":[{"aggregation":"sum"}],"color":["#2870c4","#4ecef6","#ffd43b","#fa5a5a"]}',
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#6aa7eb","aggregation":"sum"}],"pie":{"color":[],"center":["80%","20%"],"radius":"20%","aggregation":"sum","label":"{b}"},"mark":true}',
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#6aa7eb","aggregation":"sum"}],"pie":{"color":[],"center":["80%","20%"],"radius":"20%","aggregation":"sum","label":"{b}"},"label":true}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":{"aggregation":"sum","radius":["45%","60%"],"label":"{b}"},"pie":{"radius":"30%","aggregation":"sum","label":"{b}"},"color":[]}',
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#6aa7eb","aggregation":"sum"}],"mark":true,"header":{"title":"타이틀을 입력하세요","fontSize":20,"color":"#4A4A4A"},"content":{"aggregation":"sum","fontSize":50,"color":"#4A4A4A"}}',
        ...
        },
        {
          ...
          category: 'HORIZONTAL',
          option:
            '{"series":[{"color":"#6aa7eb","aggregation":"sum"}],"label":true,"header":{"title":"타이틀을 입력하세요","fontSize":20,"color":"#4A4A4A"},"content":{"aggregation":"sum","fontSize":50,"color":"#4A4A4A"}}',
        ...
        },
        {
          ...
          category: 'SQUARE',
          option:
            '{"series":{"color":[],"aggregation":"sum","label":"{b}","radius":["40%","75%"]},"header":{"title":"타이틀을 입력하세요","fontSize":20,"color":"#4A4A4A"},"content":{"aggregation":"sum","fontSize":50,"color":"#4A4A4A"}}',
    ...
    await dataSource
      ...
      .values([
        ...
        },
        {
          ...
          description:
            '주요 차트를 상단에 2가지 배열하여 비교 후 하단에 상세데이터 확인 필요 시 사용',
          useYn: YesNo.YES,
        },
        {
        ...
        },
        {
          ...
          title: '3단 구성과 상세 데이터',
          description:
            '3가지의 차트로 데이터를 확인 후 하단 영역에 상세 데이터를 배열 할 경우 사용',
          useYn: YesNo.YES,
        },
        {
        ...
        },
        {
          ...
          description:
            '주요 차트를 중앙에 노출하여 집중도를 높이고 좌우로 상세 차트를 배열 시 사용',
          useYn: YesNo.YES,
        },
        {
          ...
          description:
            '비교 가능한 4가지의 차트 배열 후 하단 영역을 크게 활용하여 차트 배열 시 사용',
          useYn: YesNo.YES,
        },
        {
          ...
          description:
            '4가지의 차트 배열 후 하단 3가지 차트 배열로 상세 차트를 같이 노출 원할 때 사용',
          useYn: YesNo.YES,
        },
        {
      ...
      .values([
        {
          ...
          password:
            '0258acb251701900c2abcde987033e032838df1eb39f10bfb9e9f6398866b13acb104f00485b92b11db90544744280626980c3888b9ba98ea8f319f9747d051e',
          userId: 'guest',
        },
      ])
      .execute();
