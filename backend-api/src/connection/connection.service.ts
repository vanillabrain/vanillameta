  ...
  addKnex(id: number, options: Knex.Config) {
    if (!this.hasKnex(id)) {
      ...
      if (dbSpecificConfig) {
        ...
        this.logger.info('Applied database-specific optimizations', 'ConnectionService', {
          databaseId: id,
          databaseType,
      ...
      if (optimizer) {
        ...
        this.logger.info('Applied optimizer-specific configurations', 'ConnectionService', {
          databaseId: id,
