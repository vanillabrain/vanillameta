...
describe('SQL Injection Prevention (E2E)', () => {
  ...
  describe('Query Length and Complexity Limits', () => {
    ...
    it('should limit result set size', () => {
      const result = sqlValidationService.validateQuery('SELECT * FROM users', { maxResultLimit: 100 });
    ...
    it('should detect deeply nested queries', () => {
      const deeplyNested = 'SELECT * FROM (' + 'SELECT * FROM ('.repeat(10) + 'SELECT 1' + ')'.repeat(10) + ')';
