...
describe('PageViewBox 컴포넌트', () => {
  ...
  describe('모바일 뷰', () => {
    ...
    it('모바일에서 긴 제목이 줄바꿈되어야 함', () => {
      const longTitle = '매우 긴 제목입니다. 이 제목은 여러 줄에 걸쳐 표시되어야 하며, 최대 3줄까지만 표시되고 나머지는 말줄임표로 처리됩니다.';
      
      renderWithProviders(
        <PageViewBox title={longTitle} />,
        { isMobile: true }
      );
