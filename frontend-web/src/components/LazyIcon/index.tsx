 ...
 * @param height - 아이콘 높이
 */
const LazyIcon: React.FC<LazyIconProps> = ({ iconName, style, fallback, width = '100%', height = '100%' }) => {
  ...
  const defaultFallback = (
    <Skeleton variant="rectangular" width={width} height={height} sx={{ backgroundColor: '#f5f5f5' }} />
  );
