export const WIDGET_TYPE = {
  ...
  CHART_MIXED_LINE_PIE: 'CHART_MIXED_LINE_PIE',
  CHART_MIXED_AREA_PIE: 'CHART_MIXED_AREA_PIE',
  CHART_MIXED_BAR_PIE: 'CHART_MIXED_BAR_PIE',
  CHART_MIXED_COLUMN_PIE: 'CHART_MIXED_COLUMN_PIE',
  CHART_MIXED_STACKED_BAR_PIE: 'CHART_MIXED_STACKED_BAR_PIE',
  CHART_MIXED_STACKED_COLUMN_PIE: 'CHART_MIXED_STACKED_COLUMN_PIE',
  CHART_MIXED_STACKED_LINE_PIE: 'CHART_MIXED_STACKED_LINE_PIE',
  CHART_MIXED_STACKED_AREA_PIE: 'CHART_MIXED_STACKED_AREA_PIE',
  CHART_MIXED_DONUT_PIE: 'CHART_MIXED_DONUT_PIE',
  CHART_MIXED_NIGHTINGALE_PIE: 'CHART_MIXED_NIGHTINGALE_PIE',
  CHART_MIXED_LINE_STACKED_BAR: 'CHART_MIXED_LINE_STACKED_BAR',
};
