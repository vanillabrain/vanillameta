...
const selectDatabaseList = (): Promise<ApiResponse<Database[]>> => get(URL_DATABASE);
...
const selectDatabaseTypeList = (): Promise<ApiResponse<DatabaseType[]>> => get(URL_DATABASE + '/type');

const createDatabase = (data: CreateDatabaseRequest): Promise<ApiResponse<Database>> => post(URL_DATABASE, data);

const updateDatabase = (id: string, data: UpdateDatabaseRequest): Promise<ApiResponse<Database>> =>
  put(URL_DATABASE + '/' + id, data);

const deleteDatabase = (id: string): Promise<ApiResponse<null>> => del(URL_DATABASE + '/' + id);
