...
const ScatterChart = lazy(() => import(/* webpackChunkName: "chart-scatter" */ '@/widget/modules/scatterchart/ScatterChart'));
...
const HeatmapChart = lazy(() => import(/* webpackChunkName: "chart-heatmap" */ '@/widget/modules/heatmapchart/HeatmapChart'));
const TreemapChart = lazy(() => import(/* webpackChunkName: "chart-treemap" */ '@/widget/modules/treemapchart/TreemapChart'));
const GaugeChart = lazy(() => import(/* webpackChunkName: "chart-gauge" */ '@/widget/modules/gaugechart/GaugeChart'));
const CandlestickChart = lazy(() => import(/* webpackChunkName: "chart-candlestick" */ '@/widget/modules/candlestickchart/CandlestickChart'));
...
const Scatter3dChart = lazy(() => import(/* webpackChunkName: "chart-3d-scatter" */ '@/widget/modules/3dchart/Scatter3dChart'));
const Bubble3dChart = lazy(() => import(/* webpackChunkName: "chart-3d-bubble" */ '@/widget/modules/3dchart/Bubble3dChart'));

// Special bar charts
const WaterfallBarChart = lazy(() => import(/* webpackChunkName: "chart-waterfall" */ '@/widget/modules/barchart/WaterfallBarChart'));
const PolarBarChart = lazy(() => import(/* webpackChunkName: "chart-polar" */ '@/widget/modules/barchart/PolarBarChart'));

// Mixed charts
const MixedLinePieChart = lazy(() => import(/* webpackChunkName: "chart-mixed-line-pie" */ '@/widget/modules/mixedchart/MixedLinePieChart'));
const MixedLineStackedBarChart = lazy(() => import(/* webpackChunkName: "chart-mixed-line-bar" */ '@/widget/modules/mixedchart/MixedLineStackedBarChart'));
const MixedDonutPieChart = lazy(() => import(/* webpackChunkName: "chart-mixed-donut-pie" */ '@/widget/modules/mixedchart/MixedDonutPieChart'));
...
export const ChartComponent: FC<ChartProps> = ({ widgetType, option, dataSet }) => {
  ...
  const getChartComponent = useMemo(() => {
    ...
    const ChartLookUpTable = {
      ...
      [WIDGET_TYPE.MIXED_CHART_STACKED_LINE_BOARD_NUMERIC]: () => <MixedLinePieChart stackedLine={stackedLine} boardNumeric {...rest} />,
      [WIDGET_TYPE.MIXED_CHART_STACKED_AREA_BOARD_NUMERIC]: () => <MixedLinePieChart stackedArea={stackedArea} boardNumeric {...rest} />,
      [WIDGET_TYPE.MIXED_CHART_STACKED_BAR_BOARD_NUMERIC]: () => <MixedLinePieChart stackedBar={stackedBar} boardNumeric {...rest} />,
      [WIDGET_TYPE.MIXED_CHART_STACKED_COLUMN_BOARD_NUMERIC]: () => <MixedLinePieChart stackedColumn={stackedColumn} boardNumeric {...rest} />,
      [WIDGET_TYPE.MIXED_CHART_DONUT_BOARD_NUMERIC]: () => <MixedDonutPieChart donut={donut} boardNumeric {...rest} />,
      [WIDGET_TYPE.MIXED_CHART_NIGHTINGALE_BOARD_NUMERIC]: () => <MixedDonutPieChart nightingale={nightingale} boardNumeric {...rest} />,
    };
