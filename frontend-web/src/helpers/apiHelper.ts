...
//     if (error?.response?.data?.message === 'accessTokenExpired' && !prevRequest?.sent) {
//       prevRequest.sent = true;
//       // const newToken = useRefresh();
//       // prevRequest.headers['Authorization'] = `Bearer ${newToken}`;
//       // return instance(prevRequest);
//     } else if (prevRequest?.sent) {
//       // return axios.interceptors.request.eject(instance)
//     }
//     error.message =
