...
class EnhancedAnalyticsService {
   ...
   * 성능 메트릭 추적
   */
  public trackPerformance(metricName: string, value: number, unit = 'ms'): void {
   ...
   * 이벤트 플러시
   */
  private async flushEvents(forceSend = false): Promise<void> {
  ...
  private async sendToGoogleAnalytics(
    events: Array<{ action: EventAction; category: EventCategory; data: EventData }>,
  ): Promise<void> {
