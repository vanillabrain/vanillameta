...
export const trackDashboard = {
  ...
  exported: (dashboardId: string, format: string) => {
    eventTracker.track(
      EventAction.DASHBOARD_EXPORTED,
      EventCategory.DASHBOARD,
      {
        dashboardId,
        exportFormat: format
...
export const trackDatabase = {
  ...
  disconnected: (databaseId: string) => {
    eventTracker.track(
      EventAction.DATABASE_DISCONNECTED,
      EventCategory.DATABASE,
      {
        databaseId
      }
  ...
  queryExecuted: (queryId: string, datasetId: string, executionTime: number, rowCount?: number, success: boolean = true) => {
    eventTracker.track(
...
export const trackShare = {
  linkCreated: (shareId: string, dashboardId: string, permission: 'view' | 'edit', expirationDays?: number) => {
    eventTracker.track(
      EventAction.SHARE_LINK_CREATED,
      EventCategory.SHARE,
      {
        shareId,
        dashboardId,
  ...
  linkAccessed: (shareId: string, dashboardId: string) => {
    eventTracker.track(
      EventAction.SHARE_LINK_ACCESSED,
      EventCategory.SHARE,
      {
        shareId,
        dashboardId
  ...
  linkExpired: (shareId: string, dashboardId: string) => {
    eventTracker.track(
      EventAction.SHARE_LINK_EXPIRED,
      EventCategory.SHARE,
      {
        shareId,
        dashboardId
